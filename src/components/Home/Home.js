        ...
        <Container className="home-content">
          <Row>
            <Col md={7} className="home-header">
              <h1 style={{ paddingBottom: 15,marginLeft:'50px' }} className="heading">
                Salut!{" "}
              ...
              <div style={{display:'flex', alignItems:'center',justifyContent:"center",flexDirection:'column',paddingTop:'10px'}}>
                <h4>Dr.Abdessabour Sebbar <MdVerified color="gold"/></h4>
              </div>
              ...
              {/* <h1 className="heading-name">
                Je suis
                <strong className="main-name"> Abdessabour Sebbar </strong>
              </h1> */}
